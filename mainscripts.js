function showInfo(){
  ...
  if(a == "complogo"){
    ...
    top.innerHTML = "What am I good at?";
    ...
    top.innerHTML = "Why should you choose me?";
  }
    ...
    top.innerHTML = "What do I like working on?";
  }
  else if(a == "maglogo"){
    ...
    top.innerHTML = "Want to know more?";
  }
}
